...
* [`src/kkj_list/`](src/kkj_list/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/kkj_list/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `kkj-list` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/kkj_list/config.cljs) defaults to `true` in
...
```clj
(ns kkj-list.example
  (:require [kkj-list.config :as config])
